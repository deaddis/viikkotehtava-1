...
public partial class G2415_Tehtava6 : System.Web.UI.Page
{
    ...
    protected void btnUusiPelaaja_Click(object sender, EventArgs e)
    {
        ...
        OleDbCommand cmds = new OleDbCommand("INSERT INTO Pisteet (id, sukunimi, etunimi, seura, pelipaikka) VALUES('"+i+"','"+txtboxUusiSukunimi.Text+"','"+txtboxUusiEtunimi.Text+"','"+cmbSeura.SelectedValue+"','"+cmbPelipaikka.SelectedValue+"')");
